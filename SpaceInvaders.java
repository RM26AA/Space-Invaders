...
import java.util.ArrayList;     //store all aliens and bullets we fire
import java.util.Random;        //randomly choose color of each alien
import javax.swing.*;
public class SpaceInvaders extends JPanel implements ActionListener, KeyListener {
    ...
    SpaceInvaders() {
        ...
        //wallImage = new ImageIcon("E:/Games/PacMan/src/img/wall.png").getImage();

        shipImg = new ImageIcon("E:/Games/Space Invaders/Space Invaders/src/img/ship.png").getImage();
        alienImg = new ImageIcon("E:/Games/Space Invaders/Space Invaders/src/img/alien.png").getImage();
        alienCyanImg = new ImageIcon("E:/Games/Space Invaders/Space Invaders/src/img/alien-cyan.png").getImage();
        alienMagentaImg = new ImageIcon("E:/Games/Space Invaders/Space Invaders/src/img/alien-magenta.png").getImage();
        alienYellowImg = new ImageIcon("E:/Games/Space Invaders/Space Invaders/src/img/alien-yellow.png").getImage();
    ...
    @Override
    public void actionPerformed(ActionEvent e) {    //call this function continually
        move();
        repaint();
        if (gameOver) {
            gameLoop.stop();
